...
int main(){
	...
	*/
	...
	//cout<<"enter starting IP and ending IP :"<<endl;

	string source_ip_address, source_ip_address_old="", destination_ip_address;
	cout << "Enter source and destination IP addresses : \n";
	while(cin>>source_ip_address){
		...
		cout<<"\nSearching for a path from :\n"<<source_ip_address<<"  to : "<<destination_ip_address<<endl;
